...
$(function () {
    ...
    switch (location.pathname) {
        ...
        case "/help.html":
            if (!("g" in parameters) && !("c" in parameters)) {
                $(".help-html").html(`
                ...
                `);
            } else if ("g" in parameters && !("c" in parameters)) {
                $.ajax({
                    ...
                    if (data["status"] != "ok") {
                        ...
                        for (n of data) {
                            $(".help-html").append(`
                                <a href="/help.html?g=${parameters["g"]}&c=${n[0]}" class="item description" data-description="${n[1]}">${n[0]}</a>
                            `);
                        };
                    };
                });
